...
```markdown
Read: .agents/skills/security/security-prompts/auth-authorization/[number]_[name].md
```
...
.agents/skills/security/security-prompts/prompt-engineering/02_authenticated_endpoint.md

Add ownership verification with:
.agents/skills/security/security-prompts/auth-authorization/03_ownership.md"
```
...
.agents/skills/security/security-prompts/auth-authorization/04_auth_testing.md
