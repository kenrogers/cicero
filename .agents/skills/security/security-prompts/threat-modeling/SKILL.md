...
```markdown
Read: .agents/skills/security/security-prompts/threat-modeling/[number]_[name].md
```
...
.agents/skills/security/security-prompts/threat-modeling/01_stride_analysis.md"
```
...
.agents/skills/security/security-prompts/threat-modeling/04_code_review.md
...
.agents/skills/security/security-prompts/threat-modeling/06_owasp_check.md"
```
