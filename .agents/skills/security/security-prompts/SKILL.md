...
**Location**: `.agents/skills/security/security-prompts/prompt-engineering/`
...
**Location**: `.agents/skills/security/security-prompts/threat-modeling/`
...
**Location**: `.agents/skills/security/security-prompts/auth-authorization/`
...
**Location**: `.agents/skills/security/security-prompts/built-in-controls/`
...
**Template**: `.agents/skills/security/security-prompts/[category]/[file].md`
...
"Use the STRIDE analysis template from .agents/skills/security/security-prompts/threat-modeling/01_stride_analysis.md to create a threat model"
...
```
Read: .agents/skills/security/security-prompts/[category]/[template].md
```
