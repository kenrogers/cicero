...
```markdown
Read: .agents/skills/security/security-prompts/prompt-engineering/[number]_[name].md
```
...
→ Use: .agents/skills/security/security-prompts/auth-authorization/01_rbac_implementation.md
...
Step 4: Code review
→ Use: .agents/skills/security/security-prompts/threat-modeling/04_code_review.md

Step 5: Update threat model
→ Use: .agents/skills/security/security-prompts/threat-modeling/08_update_model.md
```
...
→ Use: .agents/skills/security/security-prompts/auth-authorization/03_ownership.md

Step 3: Test authorization
→ Use: .agents/skills/security/security-prompts/auth-authorization/04_auth_testing.md
