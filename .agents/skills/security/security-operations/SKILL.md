...
- `.agents/skills/security/security-overview/SKILL.md` - Overall architecture
- `.agents/skills/security/*/SKILL.md` - Individual security features
- `docs/security/SECURITY_IMPLEMENTATION.md` - Complete implementation guide
- `README.md` - Security Configuration section

**Awareness & Learning:**
- `.agents/skills/security/security-awareness/` - AI code vulnerability analysis
- `.agents/skills/security/security-awareness/awareness-overview/` - Complete security overview
